// PDF出力（html2canvas + jsPDF、ページ別キャプチャ方式）
...
// ページ1: 見積もり明細
function buildPage1(estimate, price) {
...
export async function exportPdf(estimate, price) {
  ...
  // ページごとに個別キャプチャ
  await renderPage(buildPage1(estimate, price), pdf, true);
  await renderPage(buildPage2(estimate), pdf, false);
  await renderPage(buildPage3(estimate), pdf, false);
